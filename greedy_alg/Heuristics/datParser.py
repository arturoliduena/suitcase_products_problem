...
import os, re
from Heuristics.AMMMGlobals import AMMMException
...
class DATParser(object):
    ...
    def parse(filePath):
        ...
        for entry in entries:
            ...
            datAttr.__dict__[entry[0]] = [DATParser._tryParse(v) for v in values]
        ...
        for entry in entries:
            ...
            for entry2 in entries2:
                ...
                values.append([DATParser._tryParse(v) for v in values2])
